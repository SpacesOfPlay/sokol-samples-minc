...
// cube-sapp.glsl, hand-ported to minc @shader.
// Interface mirrors the sokol-shdc program `cube`:
//   attrs: position(0), color0(1); uniform block 0: vs_params { mvp }.
...
@shader fragment
float4 cube_sapp_fs(CubeVsOut input) {
...
// Replaces the sokol-shdc generated cube-sapp.glsl.h.
struct vs_params_t {
    mat44_t mvp;
}
...
void init() {
    ...
    sg_shader shd = sokol_make_shader(&cube_sapp_vs_shader, &cube_sapp_fs_shader);
