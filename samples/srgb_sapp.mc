...
// srgb-sapp.glsl - ported to minc @shader.

struct SrgbSappVsOut {
    float4 pos;
    float4 color;
}
...
void init() {
    ...
    sg_shader shd = sokol_make_shader(&srgb_sapp_vs_shader, &srgb_sapp_fs_shader);
